...
[Script]
Sub_info = type=generic,timeout=10,script-path=https://raw.githubusercontent.com/Mubdao/Self-use/main/Surge/JS/sub_info_panel.js,script-update-interval=0,argument=url=[URL encode 后的机场节点链接]&reset_day=1&title=AmyInfo&icon=bonjour&color=#007aff
...
function bytesToSize(bytes) {
  ...
  let k = 1024;
  sizes = ["B", "KB", "𝗠𝗕", "𝗚𝗕", "TB", "PB", "EB", "ZB", "YB"];
